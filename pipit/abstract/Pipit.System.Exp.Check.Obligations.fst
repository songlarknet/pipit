...
let rec check_step_obl
  ...
  | XMufby acc seed f g ->
    // The fused-loop obligation follows structurally: the composite step's
    // obligations are exactly the f- and g- sub-step obligations, and
    ...
    check_step_obl rows_f (CR.cons reg_acc row1) f sf;
    check_step_obl rows_g (CR.cons v_out   row1) g sg;
    ()
